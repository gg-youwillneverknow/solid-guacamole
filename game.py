...
class Game(object):
    ...
    def run( self ):
        ...
        if not os.path.exists(filename):
            f = open(filename,'w')
            header='tick,width,height,pacman_posX,pacman_posY,legal_action1,legal_action2,legal_action3,legal_action4,legal_action5,pacman_dir,num_ghosts,living_ghosts1,,living_ghosts2,living_ghosts3,living_ghosts4,ghosts_pos1X,ghosts_pos1Y,ghosts_pos2X,ghosts_pos2Y,ghosts_pos3X,ghosts_pos3Y,ghosts_pos4X,ghosts_pos4Y,ghosts_dir1,ghosts_dir2,ghosts_dir3,ghosts_dir4,ghosts_dist1,ghosts_dist2,ghosts_dist3,ghosts_dist4,pac_dots,dist_nearest_pac_dots,map,score\n'
            f.write(header)
        f.close()
        f = open(filename,'a')
